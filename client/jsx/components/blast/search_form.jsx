...
var SearchForm = React.createClass({
	...
	render: function () {		
		...
		if (this.props.blastType == 'sgd') {
		        return (<div>
			       <span style={{ textAlign: "center" }}><h1><i>S. cerevisiae</i> WU-BLAST2 Search <a target="_blank" href="https://sites.google.com/view/yeastgenome-help/sequence-help/blast"><img src="http://www.yeastgenome.org/images/icon_help_circle_dark.png"></img></a></h1>
			       <hr /></span>
			       {formNode}
			</div>);
		}
		        ...
		        return (<div>
                               <span style={{ textAlign: "center" }}><h1>Fungal Genomes Search using WU-BLAST2 <a target="_blank" href="https://sites.google.com/view/yeastgenome-help/sequence-help/fungal-blast"><img src="http://www.yeastgenome.org/images/icon_help_circle_dark.png"></img></a></h1>
			       <hr /></span>
                               {formNode}
                        </div>);
		}
